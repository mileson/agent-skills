...
使用方法:
    python3 check_doc_size.py --doc-path Documentation/ [--warn 400] [--max 500]
"""
...
def check_doc_size(
    ...
    for md_file in doc_root.rglob("*.md"):
        # 跳过文件夹说明书和特殊文件
        if md_file.name == "00_文档规范.md" or md_file.name == "README.md" or md_file.name.endswith("_README.md"):
            continue
